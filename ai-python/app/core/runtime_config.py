...
CONFIG_ENV_MAPPING: dict[tuple[str, ...], str] = {
    ...
    ("llm", "io-max-workers"): "LLM_IO_MAX_WORKERS",
    ("llm", "async-http", "max-connections"): "ASYNC_MODEL_HTTP_MAX_CONNECTIONS",
    ("llm", "async-http", "max-keepalive-connections"): "ASYNC_MODEL_HTTP_MAX_KEEPALIVE_CONNECTIONS",
    ("llm", "async-http", "keepalive-expiry-seconds"): "ASYNC_MODEL_HTTP_KEEPALIVE_EXPIRY_SECONDS",
    ("llm", "async-http", "max-in-flight"): "ASYNC_MODEL_HTTP_MAX_IN_FLIGHT",
    ("llm", "async-http", "acquire-timeout-seconds"): "ASYNC_MODEL_HTTP_ACQUIRE_TIMEOUT_SECONDS",
    ("llm", "async-http", "connect-timeout-seconds"): "ASYNC_MODEL_HTTP_CONNECT_TIMEOUT_SECONDS",
    ("llm", "async-http", "default-timeout-seconds"): "ASYNC_MODEL_HTTP_DEFAULT_TIMEOUT_SECONDS",
    ...
    ("rag", "embedding", "timeout-seconds"): "RAG_EMBEDDING_TIMEOUT_SECONDS",
    ("rag", "embedding", "batch-max-size"): "RAG_EMBEDDING_BATCH_MAX_SIZE",
    ("rag", "embedding", "batch-wait-ms"): "RAG_EMBEDDING_BATCH_WAIT_MS",
    ("rag", "embedding", "max-in-flight"): "RAG_EMBEDDING_MAX_IN_FLIGHT",
    ("rag", "retrieval", "io-workers"): "RAG_RETRIEVAL_IO_WORKERS",
    ("rag", "index", "chunk-workers"): "RAG_INDEX_CHUNK_WORKERS",
    ...
    ("rag", "llm", "temperature"): "RAG_LLM_TEMPERATURE",
    ("rag", "text-correction", "enabled"): "RAG_TEXT_CORRECTION_ENABLED",
    ("rag", "text-correction", "model"): "RAG_TEXT_CORRECTION_MODEL",
    ("rag", "text-correction", "base-url"): "RAG_TEXT_CORRECTION_BASE_URL",
    ("rag", "text-correction", "timeout-seconds"): "RAG_TEXT_CORRECTION_TIMEOUT_SECONDS",
    ("rag", "text-correction", "batch-max-items"): "RAG_TEXT_CORRECTION_BATCH_MAX_ITEMS",
    ("rag", "text-correction", "batch-max-chars"): "RAG_TEXT_CORRECTION_BATCH_MAX_CHARS",
    ("rag", "text-correction", "min-similarity"): "RAG_TEXT_CORRECTION_MIN_SIMILARITY",
    ...
    ("review", "segment", "request-timeout-seconds"): "REVIEW_SEGMENT_REQUEST_TIMEOUT_SECONDS",
    ("review", "segment", "cockpit-request-retries"): "REVIEW_SEGMENT_COCKPIT_REQUEST_RETRIES",
    ("review", "segment", "max-generation-attempts"): "REVIEW_SEGMENT_MAX_GENERATION_ATTEMPTS",
    ("review", "segment", "max-merge-rounds"): "REVIEW_SEGMENT_MAX_MERGE_ROUNDS",
    ...
    ("review", "langextract", "max-workers"): "REVIEW_LANGEXTRACT_MAX_WORKERS",
    ("review", "langextract", "max-model-requests"): "REVIEW_LANGEXTRACT_MAX_MODEL_REQUESTS",
    ("review", "langextract", "timeout-seconds"): "REVIEW_LANGEXTRACT_TIMEOUT_SECONDS",
    ...
    ("rag", "kafka", "worker", "auto-offset-reset"): "RAG_KAFKA_AUTO_OFFSET_RESET",
    ("rag", "kafka", "worker", "max-poll-interval-ms"): "RAG_KAFKA_MAX_POLL_INTERVAL_MS",
    ("rag", "kafka", "worker", "handler-concurrency"): "RAG_KAFKA_HANDLER_CONCURRENCY",
    ("rag", "kafka", "worker", "control-concurrency"): "RAG_KAFKA_CONTROL_CONCURRENCY",
    ...
    ("workers", "outbox", "publish-concurrency"): "RAG_OUTBOX_PUBLISH_CONCURRENCY",
    ...
    ("workers", "agent", "batch-size"): "AGENT_WORKER_BATCH_SIZE",
    ("workers", "agent", "concurrency"): "AGENT_WORKER_CONCURRENCY",
    ...
    ("workers", "rag-task", "concurrency"): "RAG_TASK_WORKER_CONCURRENCY",
    ...
    ("ocr", "bailian", "batch-max-size"): "RAG_VIDEO_OCR_BATCH_MAX_SIZE",
    ("ocr", "bailian", "batch-wait-ms"): "RAG_VIDEO_OCR_BATCH_WAIT_MS",
    ("ocr", "bailian", "max-in-flight"): "RAG_VIDEO_OCR_MAX_IN_FLIGHT",
    ("ocr", "lang"): "OCR_LANG",
    ...
    ("asr", "audio-via-oss"): "RAG_ASR_AUDIO_VIA_OSS",
    ("asr", "require-oss-audio-url"): "RAG_ASR_REQUIRE_OSS_AUDIO_URL",
    ("asr", "oss-cleanup-enabled"): "RAG_ASR_OSS_CLEANUP_ENABLED",
    ...
    ("asr", "batch-max-size"): "RAG_ASR_BATCH_MAX_SIZE",
    ...
    ("video", "parallel-workers"): "RAG_VIDEO_PARALLEL_WORKERS",
    ...
    ("video", "asr-audio-bitrate"): "RAG_ASR_AUDIO_BITRATE",
