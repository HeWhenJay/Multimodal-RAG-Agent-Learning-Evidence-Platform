    ...
    fields = [
        {
            ...
            "requiredEvidencePolicy": request.fieldEvidencePolicies.get(field.fieldId, field.requiredEvidencePolicy),
            "userInstruction": request.fieldInstructions.get(field.fieldId, ""),
