...
| `LearningMaterials` | `material_list_view`、`material_upload_start`、`material_upload_success`、`material_upload_failed` |
| `KnowledgeBase` | `rag_query_submit`、`rag_query_success`、`rag_query_no_evidence`、`rag_query_failed` |
| `ResumeAdaptation` | `page_view_resume_adaptation` |
